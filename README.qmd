...
confirm that I have not excluded important parameter codes or otherwise 
...
pull water temperature data with the appropriate parameter code. I could have
...
Next, let's view the water temperature data pull results. As expected, the water
temperature dataframe was empty.
